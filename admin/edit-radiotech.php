...
<head>
    ...
    <title>Edit Radio Technician</title>
...
<body>
    <div class="main-wrapper">
        ...
        <?php
					$r_id=$_GET['id'];
					$sql1 = "Select * from radiotech where id=$r_id";
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Edit Radio Technician</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="php/edit-radiotech.php" id="registration" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    <input type="hidden" name="id" value="<?php echo $_GET['id'];?>">
                                        <label>First Name <span class="text-danger">*</span></label>
                                        <input name="fname" class="form-control" value="<?php echo $row["fname"];?>" type="text" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Last Name <span class="text-danger">*</span></label>
                                        <input name="lname" class="form-control" value="<?php echo $row["lname"];?>" type="text" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="username" class="form-control" value="<?php echo $row["username"];?>" type="text" required readonly>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Edit Technician</button>
                            </div>
                        </form>
                    </div>
                </div>
