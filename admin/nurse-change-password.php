    ...
    <div class="main-wrapper">
        <div class="header">
			<div class="header-left">
				<a href="nurse-pannel.php" class="logo">
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                ...
                <ul>
                        ...
                        <li >
                            <a href="nurse-pannel.php"><i class="fa fa-calendar"></i> <span>Critical Patients</span></a>
                        </li>
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    ...
                    ?>
                        <form action="php/nurse-change-pass.php" method="post">
                            <div class="row">
                                <div class="col-sm-12">
