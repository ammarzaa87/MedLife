...
$id = $_SESSION['n_id'];
$sql1="Select * from nurses where id=? and password=?"; #Check if old pass already exists in the database
...
if(empty($row)){
    ...
    header('location: ../nurse-change-password.php');
}
else{
	...
	if ($_POST["new"] === $_POST["confirm"]) {
        if($realold === $newhash){
            ...
            $sql = "UPDATE nurses SET password = '$newhash' where id=$id";
