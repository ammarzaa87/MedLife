...
$sql1="Select * from radiotech where username=?"; #Check if the username already exists in the database
...
if(empty($row)){
		...
		$sql4 = "INSERT INTO `radiotech` (`fname`, `lname`,`phone` ,`gender`,`username`,`password`,`birth`) VALUES (?,?,?,?,?,?,?);"; #add the new lab tech to the database
    ...
    header('location: ../add-radiotech.php');
}
?>