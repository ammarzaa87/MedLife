...
<head>
    ...
    <title>Add Radio Technician</title>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Add Radio Technician</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="php/add-radiotech.php" id="registration" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-6">
					...
					/* If username is already taken, print a danger alert that tells "username is already taken"*/
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Add Technician</button>
                            </div>
                        </form>
                    </div>
                </div>
