...
<body>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                ...
                <ul>
                        ...
                        <li class="active">
                            <a href=""><i class="fa fa-calendar"></i> <span>Radio Tests</span></a>
                        </li>
                        ...
                        <li>
                            <a href="radio-change-password.php"><i class="fa fa-lock"></i> <span>Change Password</span></a>
                        </li>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form enctype="multipart/form-data" id="data"  method="POST" action="php/add-radio.php">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Radio Tests</h4>
                    </div>
				...
				<div class="row">
				   ...
				   $sql1 = "SELECT D.id,D.date, P.fname,P.lname,P.birth,R.name 
                   FROM doradio AS D,patients AS P, radios AS R WHERE D.radio_id=R.id AND D.patient_ssn=P.ssn AND D.status=1 order by D.date;";
				   $stmt1 = $connection->prepare($sql1);
				   $stmt1->execute();
					$result = $stmt1->get_result();
