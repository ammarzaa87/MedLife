...
<body>
    <div class="main-wrapper">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    ...
                    <li class="menu-title">Main</li>
						...
						<li class="active">
                            <a href=""><i class="fa fa-medkit"></i> <span>Lab Technician</span></a>
                        </li>
						<li>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-labtech.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Lab Technician</a>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            ...
                            <div class="dropdown profile-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="edit-labtech.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    <a class="dropdown-item" data-role="delete" data-toggle="modal" data-id="<?php echo $row['id'];?>" data-target="#delete_lab" ><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                </div>
                            </div>
        ...
        <div id="delete_lab" class="modal fade delete-modal" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-body text-center">
						<img src="assets/img/sent.png" alt="" width="50" height="46">
						<h3>Are you sure want to delete this Lab Technician?</h3>
...
$(document).ready(function(){
	...
	//alert($(this).data('id'));
	var id = $('#lid').val();
   location.replace("php/delete-labtech.php?ltech_id="+id)
});
