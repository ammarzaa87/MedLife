...
<body>
    <div class="main-wrapper">
        ...
        <?php
					$l_id=$_GET['id'];
					$sql1 = "Select * from labtech where id=$l_id";
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Edit Lab Technician</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="php/edit-labtech.php" id="registration" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-6">
