...
<body>
    <div class="main-wrapper">
        ...
        <?php
					$n_id=$_GET['id'];
					$sql1 = "Select * from nurses where id=$n_id";
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="php/edit-nurse.php" id="registration" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Edit Nurse</button>
                            </div>
                        </form>
                    </div>
                </div>
