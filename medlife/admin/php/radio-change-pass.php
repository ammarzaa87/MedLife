...
$id = $_SESSION['r_id'];
$sql1="Select * from radiotech where id=? and password=?"; #Check if old pass already exists in the database
...
if(empty($row)){
    ...
    header('location: ../radio-change-password.php');
}
else{
	...
	if ($_POST["new"] === $_POST["confirm"]) {
        if($realold === $newhash){
            ...
            $sql = "UPDATE radiotech SET password = '$newhash' where id=$id";
