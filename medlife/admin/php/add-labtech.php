...
$sql1="Select * from labtech where username=?"; #Check if the username already exists in the database
...
if(empty($row)){
		...
		$sql4 = "INSERT INTO `labtech` (`fname`, `lname`,`phone` ,`gender`,`username`,`password`,`birth`) VALUES (?,?,?,?,?,?,?);"; #add the new lab tech to the database
    ...
    header('location: ../add-labtech.php');
}
?>